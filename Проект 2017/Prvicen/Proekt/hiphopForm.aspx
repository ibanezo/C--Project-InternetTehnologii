<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hiphopForm.aspx.cs" Inherits="hiphopForm" %>
...
<head id="Head1" runat="server">
    ...
    <title>Hip Hop Artist Vote Form</title>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="container-fluid">
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-sm-4">
                        <h2>Hip Hop Artist Vote Form</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="wrapper wrapper-content animated fadeInUp">
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <form method="get" class="form-horizontal">
                                        <div class="form-group"><label class="col-sm-2 control-label">Biography Link</label>
                                            <div class="col-sm-10"><input type="text" class="form-control"></div>
                                        </div>
                                    </form>
                                    <form method="get" class="form-horizontal">
